 ...
 *	   1 on success
 */
uint8_t is_my_unreachable(struct unreachable_packet *packet, 
			  const struct echo_packet *sent, struct in6_addr * myip)
{
 ...
 *	   1 on success
 */
uint8_t is_my_time_exceed(struct ttl_packet * buffer,
			  const struct echo_packet *sent, struct in6_addr * myip)
{
	       ...
	       struct in6_addr **hopip)
{
	...
	struct ttl_packet ttl;
	struct unreachable_packet unreach;
...
/*===========================================================================*/
	...
	int i;
	ssize_t ret;
	fprintf(stderr, "nu mai trimiteti atata chizdelor:\n", strerror(errno));
