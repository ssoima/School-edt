 ...
 *
 * \param fd The soket to write to
...
/*
 * Get the layer 2 address of the device a socket opned by grnvs_open is
 * associated with
 */
...
/*
 * Get the layer 3 address of the device a socket opned by grnvs_open is
 * associated with
 *
